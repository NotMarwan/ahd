...
const PLANS: readonly Plan[] = [
  ...
  },
  {
    ...
    features: ['تسويةٌ جماعيّة', 'قسمةٌ تلقائيّة بالأصناف', 'إدارة العهود المتكرّرة'],
  },
  {
    key: 'org',
    name: 'المؤسسة · الوقف',
  ...
  },
  {
    ...
    features: ['المحرّك كاملًا (توثيق + تسوية مختومة)', 'بندٌ يمنع الربا والغرامة والتصنيف', 'تشغيلٌ باسم المصرف'],
  },
];
