      ...
      {!sealed ? (
        ...
        <>
          ...
          <Section>
            ...
            <AhdButton label="فتح التسوية" onPress={() => router.push('/settle')} variant="secondary" />
            <AhdButton label="التحقق والمشاركة" onPress={showProof} testID="record-open-proof" variant="quiet" />
          </Section>
        </>
      )}
    </AppShell>
