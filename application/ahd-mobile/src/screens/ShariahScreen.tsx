...
const OPEN_QUESTIONS: readonly OpenQuestion[] = [
  ...
  },
  {
    ...
    questionAr:
      'هل يمتدّ حكم المقاصّة والحوالة الثنائيّة المستقرّ فقهيًّا (بين طرفين) إلى مقاصّةٍ متعدّدة الأطراف (تسويةٌ شبكيّةٌ بين أكثر من طرفين دفعةً واحدة، كما تفعلها شاشة المقاصّة في عهد)، أم يستلزم ذلك شرطًا إضافيًّا في الرضا أو صيغة العقد لم يُشترَط في الحوالة الثنائيّة؟',
