...
const PATHS = {
  ...
  settle:
    'M7 7h9l-2.5-2.5M16 7l-2.5 2.5M17 17H8l2.5 2.5M8 17l2.5-2.5M18.5 9.5a7 7 0 0 1 0 5M5.5 14.5a7 7 0 0 1 0-5',
...
export function TabIcon({ name, color, size = 22 }: TabIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" testID={`tab-icon-${name}`}>
      <Path
        d={PATHS[name]}
        stroke={color}
        strokeWidth={1.8}
