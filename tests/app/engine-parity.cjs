/* ============================================================================
   engine-parity.cjs — proves app/engine.js is a FAITHFUL copy of the
...
const ENGINE_PATH = path.join(__dirname, "..", "..", "app", "engine.js");

let pass = 0, fail = 0;
const ok = (cond, msg) => { if (cond) { pass++; console.log("  ✓ " + msg); } else { fail++; console.log("  ✗ " + msg); } };

console.log("engine-parity: faithful-copy proof for app/engine.js");
