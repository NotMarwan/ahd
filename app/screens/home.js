  ...
  function render(app) {
    ...
    return '<div class="home">' +
      ...
      '<div class="hcards">' +
        ...
        card("plans", "🧾", "الأجرة والخطط", "كيف يربح عهد — أجرةٌ على الخدمة لا على القرض، والقرض مجانيٌّ للأبد") +
        card("org", "🏛️", "لوحة المؤسسة", "صندوق قرض حسن كـ SaaS — مجاميع مجهّلة وفاتورةٌ ثابتة، بلا مالٍ مجمَّع") +
      "</div>" +
