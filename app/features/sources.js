...
(function (root, factory) {
  ...
  var SOURCES = Object.freeze([
    ...
    Object.freeze({ id: "nafith-count", nameAr: "نمو تسجيل سندات نافذ", figureAr: "أكثر من ١٦٠٬٠٠٠ إلى أكثر من ٥٬٥٠٠٬٠٠٠ سند؛ حدّ نمو ٣٤×", year: "٢٠٢٠–٢٠٢٤", kind: KIND.MEASURED, grade: GRADE.SECONDARY, citeAr: "أرقام نافذ المبلّغ عنها عبر SPA/المصادر الرسمية المسجلة في swarm/agent-3-official-stats/findings-claude.md؛ مصدر ثانوي وعدد تسجيلات فقط، لا قيمة سوق ولا حصة قروض شخصية.", usedOnAr: "أثر عهد — سلّم الدليل" }),
