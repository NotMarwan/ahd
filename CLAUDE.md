...
- `docs/CAPABILITIES-STRUCTURE.md` — the structural reference for the 2026-07-16 competitive-capability wave: every new feature module's API signatures, state shapes, app.js actions, screen wiring, CSS hooks, tests, and the add-a-capability recipe. Read this before touching any of the nine new modules.
