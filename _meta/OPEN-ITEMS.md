...
4. **Findex 35.8% 🟢 unintegrated** (primary-sourced, sits in `swarm/agent-3-official-stats/findings-claude.md`): merge into `EVIDENCE-BRIEF.md` + deck Khanah 5 — the honest non-survey demand substitute while OT-A1 stays open. Already planned as vault «دمج 10–11»; panel confirms it's the highest-value data add. [agent]
